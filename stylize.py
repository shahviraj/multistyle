...
style_image_0 = # load style images
style_image_1 = # load style images
style_image_2 = # load style images
style_image_3 = # load style images

style_image_list = [style_image_0, style_image_1]


preserve_color = False # flag
num_iter = 200 # number of fine tuning steps
alpha = 1 # strength of finetuning style

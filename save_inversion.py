...
for i, name in enumerate(names):
    ...
    #hfgiimg = Image.open(inv_dirname + 'hfgi/test_images/inversion/{:05d}.jpg'.format(i)).resize((1024,1024), Image.LANCZOS)
    #restyleimg = Image.open(inv_dirname + f'restyle_encoder/inference_results/4/{imgname}.png')
    projimg = Image.open(inv_dirname + f'stylegan2_projection_256/proj_{imgname}.png')
    ...
    projimg.save(f'/home/vjshah3/research/models/multistyle/opt_inversion_images/{imgname}_256.png')
    #e4eimg.save(f'/home/vjshah3/research/models/multistyle/e4e_inversion_images/{imgname}.png')

    #hfgiz = torch.load(f'/home/vjshah3/research/outputs/multistyle/inversion/hfgi/test_images/inversion/code_{i:05d}.pt').squeeze(0)
    #result_file = {}
    #result_file['latent'] = hfgiz
    #torch.save(result_file, f'/home/vjshah3/research/models/multistyle/hfgi_inversion_codes/{imgname}.pt')


    optz = np.load(f'/home/vjshah3/research/outputs/multistyle/inversion/stylegan2_projection_256/projected_w_{imgname}.npz')['w']
    result_file = {}
    result_file['latent'] = torch.tensor(optz).squeeze(0)

    torch.save(result_file, f'/home/vjshah3/research/models/multistyle/opt_inversion_codes/{imgname}_256.pt')
